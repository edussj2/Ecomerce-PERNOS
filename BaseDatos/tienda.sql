...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2021 a las 05:55:31
...
(1, 'Pernos', '', 'pernos.jpg'),
(2, 'Tuercas', '', 'tuercas.jpg'),
(3, 'Arandelas', '', 'arandelas.jpg'),
(4, 'Tornillería', '', 'tornilleria.jpg'),
(5, 'Maniobras', '', 'maniobras.jpg'),
(6, 'Perforación', '', 'perforacion.jpg'),
(7, 'Otros', '', 'otros.jpg');
...
CREATE TABLE `departamento` (
  ...
  `DepDescripcion` varchar(120) COLLATE utf8mb4_spanish2_ci NOT NULL
...
INSERT INTO `departamento` (`idDepartamento`, `DepDescripcion`) VALUES
(1, 'AMAZONAS'),
(2, 'ANCASH'),
(3, 'APURIMAC'),
(4, 'AREQUIPA'),
...
CREATE TABLE `distrito` (
  ...
  `DisDescripcion` varchar(120) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `distrito` (`idDistrito`, `DisDescripcion`, `idProvincia`) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
...
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `precio`, `imagen`, `inventario`, `id_categoria`, `norma`, `material`) VALUES
(1, 'PERNOS HEXAGONALES', 'Calidad: Grado 2, 5, 8 / Clase 5.8, 8.8, 10.9\r\nDiámetros: 1/4p hasta 1.1/2p / M-3 hasta M-42', 3, 'pernos_hexagonales.jpg', 50, 1, 'ANSI/ASME B18.2.1; SAE J429; D', 'ACERO; ACERO INOXIDABLE Y BRON'),
(2, 'PERNOS ESTRUCTURALES', 'Calidad: A325 - Diámetros: 1/2p hasta 1- Longitud: 1.1/2p hasta 4.1/2p', 3, 'pernos_estructurales.jpg', 50, 1, 'ANSI/ASME B18.2.1 ASTM A325', 'ACERO'),
(3, 'PERNOS INOXIDABLES', 'Calidad: Grado 2, 5, 8 / Clase 5.8, 8.8, 10.9 - Diámetros: 1/4p hasta 1.1/2p / M-3 hasta M-42', 3, 'pernos_inoxidables.jpg', 50, 1, 'ANSI/ASME B18.2.1; SAE J429; D', 'ACERO INOXIDABLE'),
(4, 'PERNOS DE BRONCE', 'Calidad: Grado 2, 5, 8 / Clase 5.8, 8.8, 10.9 - Diámetros: 1/4p hasta 1.1/2p / M-3 hasta M-42', 3, 'pernos_de_bronce.jpg', 50, 1, 'ANSI/ASME B18.2.1; SAE J429; D', 'BRONCE'),
(5, 'PERNOS COCHE', 'Calidad: Grado 2 - Diámetros: 1/4p hasta 3/4p - Longitud: 1/2\" hasta 10\"', 3, 'pernos_coche.jpg742075.jpg', 50, 1, 'ANSI/ASME B18.5', ' ACERO y ACERO INOXIDABLE'),
(6, 'PERNOS CABEZA CUADRADA', 'Punta: COPA - Diámetros: 1/4p hasta 3/4p - Longitud: 3/4p hasta 6p', 3, 'pernos_cabeza_cuadrada.jpg127216.jpg', 50, 1, 'NSI/ASME B18.6.2', 'ACERO'),
(7, 'PERNOS SOCKET ALLEN', 'Calidad: Grado 12.9 - Diámetros: 1/8p hasta 1.1/2p / M-3 hasta M-30', 3, 'pernos_socket_allen.jpg780557.jpg', 50, 1, 'ANSI/ASME B18.3, DIN 912', ' ACERO Y ACERO INOXIDABLE'),
(8, 'PERNOS SOCKET BUTTOM', 'Calidad: Grado 10.9 - Diámetros: 5/32p hasta 1/2p / M-4 hasta M-12', 3, 'pernos_socket_buttom.jpg105218.jpg', 50, 1, 'ANSI/ASME B18.3', 'ACERO Y ACERO INOXIDABLE'),
(9, 'PERNOS FLAT ALLEN', 'Calidad: Grado 10.9 - Diámetros: 3/16p hasta 3/4p / M-3 hasta M-20', 3, 'pernos_flat_allen.jpg52589.jpg', 49, 1, 'ANSI/ASME B18.3, DIN 7991', 'ACERO Y ACERO INOXIDABLE'),
(10, 'PRISIONEROS ALLEN', 'Grado 14.9 - Diámetros: 1/8p hasta 3/4p / M-3 hasta M-20', 3, 'prisioneros_allen.jpg9974910.jpg', 47, 2, ' ANSI/ASME B18.3, DIN 916', 'ACERO Y AC. INOXIDABLE'),
(11, 'PERNO CAPACHO', 'Diámetro: 1/16p hasta 3/8p - Longitud: 5/16p hasta 4p', 3, 'pernos_capacho.jpg2513411.jpg', 49, 1, 'ANSI/ASME B18.8.2', 'ACERO'),
(12, 'VARILLAS ROSCADAS', 'Diámetro: 1/16p hasta 3/8p - Longitud: ¾p hasta 4p', 3, 'varillas_roscadas.jpg5513112.jpg', 45, 1, 'ANSI/ASME B18.8.1', 'ACERO / ACERO INOXIDABLE');
...
CREATE TABLE `provincia` (
  `idProvincia` int(11) NOT NULL,
  `ProvDescripcion` varchar(120) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `idDepartamento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
INSERT INTO `provincia` (`idProvincia`, `ProvDescripcion`, `idDepartamento`) VALUES
(1, 'CHACHAPOYAS ', 1),
(2, 'BAGUA', 1),
(3, 'BONGARA', 1),
(4, 'CONDORCANQUI', 1),
...
(1, 'Ana Cespedes Ordinola', '939291596', 'anacespedes1998@gmail.com', 'b1af75d60d462f54ebaa678be6fba0d94933537c', 'user.png', 'Cliente'),
(2, 'Edu Cespedes Ordinola', '939291596', 'educespedes1998@gmail.com', 'b1af75d60d462f54ebaa678be6fba0d94933537c', 'admin.png', 'Administrador');
...
--
ALTER TABLE `departamento`
  MODIFY `idDepartamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `distrito`
--
ALTER TABLE `distrito`
  MODIFY `idDistrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1833;
...
--
ALTER TABLE `provincia`
  MODIFY `idProvincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;
...
--
ALTER TABLE `envios`
  ADD CONSTRAINT `envios_ibfk_1` FOREIGN KEY (`id_venta`) REFERENCES `ventas` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `envios_ibfk_2` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`idDistrito`) ON UPDATE CASCADE;
...
--
ALTER TABLE `productos_venta`
  ADD CONSTRAINT `productos_venta_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `productos_venta_ibfk_2` FOREIGN KEY (`id_venta`) REFERENCES `ventas` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `provincia_ibfk_1` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`idDepartamento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `ventas`
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE;
COMMIT;
